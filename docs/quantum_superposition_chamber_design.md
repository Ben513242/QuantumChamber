...
>
> 本修訂取代下文舊 rising-edge 啟動／斷電不解鎖的目標規則；M1.1 記錄保留為歷史與目前程式現況，不能當作新版已完成的證據。詳見 [M1.2 供電與保護規格](superpowers/specs/2026-09-17-m1.2-powered-origin-design.md) 與 [M2 走廊及返還規格](superpowers/specs/2026-09-17-m2-powered-corridor-design.md)。2026-09-17 使用者已核准兩份文件的技術細節、可選照明模組與保守安全策略並授權實作；M3 的任意 foreign／runtime-created world live gate 仍保留。
>
